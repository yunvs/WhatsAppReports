...
chat_df.to_csv("data/testing/chat_df.csv", index=False) # save the dataframe to a csv file
sender0_df.to_csv("data/testing/sender0_df.csv", index=False) # save the dataframe to a csv file
sender1_df.to_csv("data/testing/sender1_df.csv", index=False) # save the dataframe to a csv file
